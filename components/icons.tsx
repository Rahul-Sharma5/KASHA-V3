...
export const QuoteIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 9.983-9.609l.02-1.974c-6.953.283-12.017 5.39-12.017 12.391v6.583h12.014v-7.391h-6.007zM1.983 21v-7.391c0-5.704 3.748-9.57 9.983-9.609l.02-1.974c-6.953.283-12.017 5.39-12.017 12.391v6.583h12.015v-7.391h-6.008z" />
    </svg>
);
...
export const PanIndiaIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const SolutionsIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M14 9V5a3 3 0 0 0-3-3l-4 9v11h11.28a2 2 0 0 0 2-1.7l1.38-9a2 2 0 0 0-2-2.3zM7 22H4a2 2 0 0 1-2-2v-7a2 2 0 0 1 2-2h3" />
  </svg>
);

export const ClientIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const WhatsappIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        <path d="M19.05 4.94C17.1 3 14.65 2 12 2 6.48 2 2 6.48 2 12c0 1.77.46 3.45 1.32 4.95L2 22l5.25-1.38c1.45.79 3.08 1.21 4.75 1.21 5.52 0 10-4.48 10-10 0-2.65-1-5.1-2.95-6.96zM12 20.25c-1.48 0-2.93-.4-4.19-1.15l-.3-.18-3.12.82.83-3.04-.2-.31c-.82-1.31-1.26-2.82-1.26-4.38 0-4.54 3.68-8.22 8.22-8.22s8.22 3.68 8.22 8.22-3.68 8.22-8.22 8.22zm4.52-6.13c-.25-.12-1.47-.72-1.7-.82s-.39-.12-.56.12c-.17.25-.64.82-.79.98s-.29.17-.54.06c-.25-.12-1.06-.39-2.02-1.25-.75-.67-1.25-1.5-1.4-1.75s-.12-.38-.03-.51c.09-.12.2-.31.29-.42s.12-.2.17-.34c.06-.12.03-.25-.03-.37s-.56-1.34-.76-1.84c-.2-.5-.41-.43-.56-.43h-.48c-.17 0-.45.06-.68.31s-.86.84-.86 2.05c0 1.21.88 2.37 1 2.54s1.73 2.63 4.19 3.72c.59.26 1.05.41 1.41.53.59.17 1.13.15 1.55.09.47-.06 1.47-.6 1.68-1.18.2-.58.2-1.08.15-1.18s-.18-.12-.42-.24z"></path>
    </svg>
);
